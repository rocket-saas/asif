<section id="" class="section stay-connected">
	<div class="container">
			<div class="row">
				<div class="col-12 col-lg-7 stay-connected__content">
						<div class="icon-block">
                            <div class="icon-block__icon">
							    <img src="<?php echo get_template_directory_uri();?>/images/openhealth/icon1.svg" alt="#">
                            </div>
                            <h4 class="h4 icon-block__title">IMAS Vision</h4>
						</div>
