...
<?php
			...
			<h3 style="display:none"><?php _e('Name', 'fep') ?></h3>
			

			<table class="form-table">
				<tr style="display:none">
					<th><label for="user_login"><?php _e('Username', 'fep'); ?></label></th>
					<td><input type="text" name="user_login" id="user_login" value="<?php echo esc_attr($profileuser->user_login); ?>" disabled="disabled" class="regular-text form-control" /><br /><em><span class="description"><?php _e('Usernames cannot be changed.', 'fep'); ?></span></em></td>
				</tr>
			<tr style="display:none">
			...
			<tr style="display:none;">
				...
				<td>
					<select name="display_name" id="display_name" class="regular-text form-control">
					<?php
                        $public_display = [];
			...
			<h3 style="display:none"><?php _e('Contact Info', 'fep') ?></h3>

			<table class="form-table">
			<tr>
				<th><label for="email"><?php _e('E-mail', 'fep'); ?> <span class="description"><?php _e('(required)', 'fep'); ?></span></label></th>
				<td><input type="text" name="email" id="email" value="<?php echo esc_attr($profileuser->user_email) ?>" class="regular-text form-control" />
				<?php
			...
			<tr style="display:none">
            <th><label for="phone"><?php _e('Contact Number', 'fep'); ?></label></th>
            <td>
			
            <input type="text" name="contact_no" id="phone" value="<?php echo esc_attr( get_the_author_meta( 'phone1', $profileuser->ID ) ); ?>" class="regular-text form-control" /><br />
              </td>
</tr>
			...
			<tr id="password">
				...
				<td>
					<input type="password" name="pass1" id="pass1" class="regular-text form-control" size="16" value="" autocomplete="off" /><br /><br />
					<input type="password" name="pass2" id="pass2"  class="regular-text form-control"size="16" value="" autocomplete="off" />&nbsp;<em><span class="description"><?php _e('Type your new password again.', 'fep'); ?></span></em>
    ...
    ?></td>
			...
			<p class="submit">
				...
				<input type="submit" class="button-primary btn mt-3 btn-blue" value="<?php _e('Update', 'fep'); ?>" name="submit" />
			</p>
			</form>
		</div>
