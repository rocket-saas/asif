...
$conditionsLabel = get_sub_field('conditions_commonly_occurring_with_axspa_label');
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-9 offset-lg-3">
                ...
                <div class="comorbidities__chart__wrapper">
                    <div class="comorbidities__chart">
                        ...
                        <?php if ($conditionsLabel) : ?>
                            <h3 class="subtitle subtitle--md comorbidities__chart__title"><?php echo $conditionsLabel;?></h3>
                        <?php endif; ?> 
