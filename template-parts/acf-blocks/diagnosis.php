                ...
                <div class="diagnosis__stat text--color--white">
                    <div class="diagnosis__stat__content">
                        ...
                        <p class="content-block diagnosis__stat__text text--18">
                            On average patients experience a diagnostic delay of <span class="text--32 font-w-700">7.4 years</span>
                        </p>
                    </div>
                        ...
                        <div class="diagnosis__stat__bubbles">
                            ...
                            <ul class="diagnosis__stat__bubbles__list">
                                ...
                                <li class="diagnosis__stat__bubble diagnosis__stat__bubble-6" data-index="6">
                                    ...
                                    <img class="diagnosis__stat__bubble__line" src="<?php echo get_template_directory_uri();?>/images/axspa-numbers/diagnosis-bubble-6.svg" alt="#">
                                </li>
                            </ul>
                        </div>
                    </div>
