...
class AsgarosForum {
    ...
    function showLoginLink() {
        if (!is_user_logged_in() && $this->options['show_login_button']) {
            echo '<a class="login-link" href="http://asif.info/login/">'.__('Login', 'asgaros-forum').'</a>';
        }
    }

    function showRegisterLink() {
        if (!is_user_logged_in() && $this->options['show_register_button']) {
            echo '<a class="register-link" href="http://asif.info/register/">'.__('Register', 'asgaros-forum').'</a>';
        }
    }
