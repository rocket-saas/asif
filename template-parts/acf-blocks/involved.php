    ...
    <div class="container">
        ...
        <div class="row involved__footer">
            <div class="col-12 col-lg-4 offset-lg-4">
                <img class="involved__footer__logo" src="<?php echo get_template_directory_uri();?>/images/imas-logo.png" alt="#">
            </div>
            <div class="col-12 col-lg-10 offset-lg-1">
                <div class="involved__footer__results text--center">
                    <h4 class="h1">> 4,300 <span class="h4">respondents to date and counting!</span></h4>
                </div>
            </div>
        </div>
